...
class VirtualLocation(Intangible, total=False):
    """
    A class representing .orgs Intangible.
...
class ContactPoint(StructuredValue, total=False):
    """
    A class representing .orgs ContactPoint.
...
class PostalAddress(ContactPoint, total=False):
    """
    A class representing .orgs PostalAddress.
...
class GeoCoordinates(StructuredValue, total=False):
    """
    A class representing .orgs GeoCoordinates.
...
class LocationFeatureSpecification(PropertyValue, total=False):
    """
    A class representing .orgs LocationFeatureSpecification.
...
class Place(StructuredValue, total=False):
    """
    A class representing .orgs Place.
    See: https://schema.org/Place
    """
    address: Optional[Union[str, PostalAddress]]  # Physical address of the item.
...
class AdministrativeArea(Place, total=False):
    """
    A class representing .orgs AdministrativeArea.
...
class Country(AdministrativeArea, total=False):
    """
    A class representing .orgs Country.
...
class Audience(StructuredValue, total=False):
    """
    A class representing .orgs Audience.
...
class GeoShape(StructuredValue, total=False):
    """
    A class representing .orgs GeoShape.
